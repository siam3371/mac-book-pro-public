...
// console.log(num4, age, ages);

// const num9 = dubleIt();  

 // ২. টেম্পলেট স্ট্রিং দিয়ে একটা স্ট্রিং তৈরি করো। সেটার মধ্যে উপরে ডিক্লেয়ার করা ভেরিয়েবল এর মান ডাইনামিক ভাবে বসাও। একইভাবে উপরে একটা অবজেক্ট ডিক্লেয়ার করো। এবং ডাইনামিকভাবে উপরের অবজেক্ট এর দুইটা প্রপার্টি এর মান তোমার টেমপ্লেট স্ট্রিং এর মধ্যে বসাও। 
const name = 'kuddis ali';
const age = 54;
const phone = '01909599932';
const naptune = {name : 'jason', age:123, town : 'dhaka'}; 
 
// console.log(naptune); 
// console.log(foo);
 const string2 = `our country fanous person is ${name} this is person age ${age} this is person ${naptune.name} ${naptune.age} phone number ${phone} ${naptune.name}`;
//  console.log(string2);
// console.log(string2);
 // ৩.১ একটা প্যারামিটার ওয়ালা arrow ফাংশন ডিক্লেয়ার করো। এবং সেই ফাংশনের কাজ হবে তুমি কোন ইনপুট দিলে সেই ইনপুট সংখ্যাকে ৫ দিয়ে ভাগ করে আউটপুট দিবে।  
const input = 15;
 const parameterFunction =  function (num4, num5){
     return num4 + num5  
 }
 const redult2=  parameterFunction(3, 4 );
// console.log(redult2);
...
// console.log(addTwo(2));
 ...
 const multiplay1 = para1 + 2;
 const multiplay11 = para2 + 2;
 const multiplayTotal = multiplay1 * multiplay11;     
 return multiplayTotal;
   } 
